...
map.getView().fit([2638854.586964, 8375288.007081, 2875215.634983, 8547678.331494], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Number of flying squirrel sightings in Uusimaa region (1875-2024)</h2>';
        return titleElement;
    })(),
